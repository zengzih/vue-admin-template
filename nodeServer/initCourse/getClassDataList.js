...
const {queryParams, httpRequest, getQueryParams, sleep} = require("./nodeServer/utils");
const {insertCourseTable, insertChapterTable, insetUser, insertDecryptCharTable, insertQuestionTable, updateChapterQuestionId,
...
// clazzid, courseid, chapterId, cpi, num
// getQuestionBankInformation(74636055, 233568387, 705025417, 151953989,1)
// getStudentCourse();
/*
